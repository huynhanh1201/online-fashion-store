...
const ViewReviewModal = ({ open, onClose, userId, productId, orderId, productName }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography
          variant="subtitle1" // Use subtitle1 instead of h6
          fontWeight="600"
          color="var(--primary-color)"
          sx={{
            fontSize: { xs: '1.1rem', sm: '1.25rem' },
            lineHeight: 1.2, // Mimic h6 styling if needed
          }}
        >
          Đánh giá của bạn
        </Typography>
      ...
      <DialogContent sx={{ py: { xs: 1, sm: 2 }, px: { xs: 2, sm: 3 } }}>
        {loading ? (
                    ...
                    {reviewData.videos?.map((video, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <VideocamIcon sx={{ fontSize: { xs: 14, sm: 16 }, color: 'white' }} />
                            <Typography
                              variant="caption"
                              color="white"
