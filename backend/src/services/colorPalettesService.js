...
const getColorPaletteList = async (colorPaletteId) => {
  console.log('colorPaletteId', colorPaletteId)
  const result = await ColorPaletteModel.findOne({ colorPaletteId }).lean()
  return result
}
